...
const MainOverview = () => {
  const components = [
    ...
    },
    {
      name: "Date Picker",
      description:
        "Date selection components including single, multiple, and range pickers",
      href: "/components/date-picker",
      icon: <RiCalendarTodoLine size={24} className="text-emerald-600" />,
      category: "Actions",
      status: "stable",
    },
    {
    ...
    },
    {
      ...
      icon: <RiLoader4Line size={24} className="text-blue-500" />,
      category: "Loading States",
      status: "stable",
    },
    {
      name: "Spinner",
      description: "Animated spinners for loading and processing states",
      href: "/components/spinner",
      icon: <RiLoaderLine size={24} className="text-blue-400" />,
      category: "Loading States",
      status: "stable",
    },
    {
      ...
      icon: <RiSkullLine size={24} className="text-gray-400" />,
      category: "Loading States",
      status: "stable",
    },
    {
    ...
    {
      name: "Callout",
      description: "Highlighted information boxes for important messages",
      href: "/components/callout",
      icon: <RiCellphoneLine size={24} className="text-amber-600" />,
      category: "Loading States",
      status: "stable",
    },
    {
    ...
    {
      name: "Drawer",
      description: "Slide-in panels for additional content or actions",
      href: "/components/drawer",
      icon: <RiSidebarFoldLine size={24} className="text-violet-600" />,
      category: "Layout",
      status: "stable",
    },
    {
      ...
      icon: <RiIdCardLine size={24} className="text-indigo-600" />,
      category: "Layout",
      status: "stable",
    },
    {
      name: "Tree View",
      description: "Hierarchical data display with expandable nodes",
      href: "/components/tree-view",
      icon: <RiTreeLine size={24} className="text-green-700" />,
      category: "Layout",
      status: "stable",
    },
    {
    ...
    // {
    //   name: "Overview",
    //   description: "Dashboard overview and component library introduction",
    //   href: "/components/overview",
    //   icon: <RiDashboardLine size={24} className="text-primary-600" />,
    //   category: "General",
    //   status: "stable",
    // },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2 text-lg">
                A comprehensive collection of {components.length} reusable React components built
                with Tailwind CSS and accessible design patterns
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-white rounded-xl p-4 border border-gray-200">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-orange-100 rounded-lg">
                  <RiCodeBoxLine size={20} className="text-orange-600" />
                </div>
                <div>
            ...
            <div className="bg-white rounded-xl p-4 border border-gray-200">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-bluegray-100 rounded-lg">
                  <RiPaletteLine size={20} className="text-bluegray-600" />
                </div>
                <div>
                  <p className="text-2xl font-bold text-gray-900">
                    {categories.length - 1}
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 text-center">
            <div className="inline-flex items-center gap-2 text-gray-500 text-sm">
              ...
              <span>Looking for more components? Check back for updates!</span>
            </div>
          </div>
        </div>
      </div>
