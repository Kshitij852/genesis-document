...
const DatePickerReactPropsTable = () => {
  return (
      ...
      <Table>
        ...
        <TableBody>
          ...
          <TableRow>
            ...
            <TableDataCell className="py-4 px-6 text-gray-600 text-sm leading-relaxed">
              Position of the date picker dropdown
            </TableDataCell>
          </TableRow>
          ...
          <TableRow>
            <TableDataCell className="py-4 px-6 font-medium text-gray-900 text-sm">
              <div>
                ...
                <div className="text-xs text-gray-500 mt-1">SingleDatePicker: "MM/dd/yyyy"<br/>MultipleDatePicker: "MMM dd, yyyy"</div>
              </div>
            </TableDataCell>
            <TableDataCell className="py-4 px-6 text-gray-700 text-sm">
              <code className="bg-purple-50 text-purple-700 px-2 py-1 rounded-md text-xs font-mono">
...
export default DatePickerReactPropsTable;